...
type Config struct {
	ServicePort          int    `yaml:"port" env:"PORT" env-default:"50056"`
...
func LoadConfig() (*Config, error) {
	var cfg struct {
		Root             Config          `yaml:"authserver"`
		CharacterService char.Config     `yaml:"charserver"`
	...
	cfg.Root.CharacterServicePort = cfg.CharacterService.ServicePort
