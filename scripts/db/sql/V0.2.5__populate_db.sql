...
insert into equip_slots values (DEFAULT, 'ES_NECK', 'Neck');
insert into equip_slots values (DEFAULT, 'ES_SHOULDERS', 'Shoulders');
insert into equip_slots values (DEFAULT, 'ES_BACK', 'Back');
insert into equip_slots values (DEFAULT, 'ES_CHEST', 'Chest');
insert into equip_slots values (DEFAULT, 'ES_WRIST', 'Wrist');
insert into equip_slots values (DEFAULT, 'ES_HANDS', 'Hands');
insert into equip_slots values (DEFAULT, 'ES_LEGS', 'Legs');
insert into equip_slots values (DEFAULT, 'ES_FEET', 'Feet');
insert into equip_slots values (DEFAULT, 'ES_FINGER_1', 'Ring');
insert into equip_slots values (DEFAULT, 'ES_FINGER_2', 'Ring');
