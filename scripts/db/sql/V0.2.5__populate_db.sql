...
insert into vendors values (DEFAULT, 'Rha''el the Binder', 'wraith''s armory');
insert into vendors values (DEFAULT, 'Khalor', 'shaper of blade');
insert into vendors values (DEFAULT, 'Sera''ana', 'thread of ward');
insert into vendors values (DEFAULT, 'Grunmar', 'ironsong forge');
insert into vendors values (DEFAULT, 'Ebon''s Eye', 'shadow-bound relics');
insert into vendors values (DEFAULT, 'Ayla', 'moon-loom');
insert into vendors values (DEFAULT, 'Vor''dak', 'bloodrune trading');
insert into vendors values (DEFAULT, 'Nimue', 'spellforge');
insert into vendors values (DEFAULT, 'Harth', 'stonehide emporium');
insert into vendors values (DEFAULT, 'Zul''thar', 'banecraft');
insert into vendors values (DEFAULT, 'Mira', 'silk and steel');
insert into vendors values (DEFAULT, 'Thol', 'hunter''s ward');
...
insert into vendor_wares values (5, 1);
insert into vendor_wares values (6, 2); 
insert into vendor_wares values (7, 1);
insert into vendor_wares values (8, 2); 
insert into vendor_wares values (9, 1);
insert into vendor_wares values (9, 2);
insert into vendor_wares values (10, 1);
insert into vendor_wares values (11, 2);
insert into vendor_wares values (12, 1);
insert into vendor_wares values (12, 2);
insert into vendor_wares values (13, 1);
insert into vendor_wares values (14, 2);
insert into vendor_wares values (15, 1);
insert into vendor_wares values (15, 2);
insert into vendor_wares values (16, 2);